...
{
// походы
   видТуризма = immutable(EnumFormat)([0:"", 1:"пешеходный",2:"лыжный",3:"горный",
		4:"водный",5:"велосипедный",6:"автомото",7:"спелео",8:"парусный",
		9:"конный",10:"комбинированный" ]);
		// виды туризма
				
	категорияСложности = immutable(EnumFormat)([ 0:"н.к.",1:"первая",2:"вторая",3:"третья",4:"четвёртая",5:"пятая",6:"шестая",
		7:"путешествие",8:"любая",9:"ПВД" ,10:"" ]);
		// категории сложности
	элементыКС = immutable(EnumFormat)([0:"",1:"с эл.1",2:"с эл.2",3:"с эл.3",4:"с эл.4",5:"с эл.5",6:"с эл.6"]);
		
	готовностьПохода = immutable(EnumFormat)([0:"",1:"планируется",2:"набор группы",3:"набор завершён",4:"идёт подготовка",
		5:"на маршруте",6:"пройден",7:"пройден частично",8:"не пройден"]);
		
	статусЗаявки = immutable(EnumFormat)([0:"",1:"не заявлен",2:"подана заявка",3:"отказ в заявке",4:"заявлен",
		5:"засчитан",6:"засчитан частично",7:"не засчитан"]);
		

	// туристы
	
	 спортивныйРазряд = immutable(EnumFormat)([1000:"",900:"без разряда",
	 ...
	 судейскаяКатегория = immutable(EnumFormat)([1000:"",900:"без категории", 402:"вторая",401:"первая",202:"всероссийская",
	201:"всесоюзная",101:"международная"], false);
}