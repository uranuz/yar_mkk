module mkk.main.enums;

// Перечислимые типы, использемые в предметной области МКК
import webtank.datctrl.enum_format: enumFormat;
import std.typecons: t = tuple;

static immutable months = enumFormat([
	t(1, "январь"),
	t(2, "февраль"),
	t(3, "март"),
	t(4, "апрель"),
